...
export WCURLY_CLEAN_RESUME_PLY="${WCURLY_CLEAN_RESUME_PLY:-${result_root}/clean_hair_stage1_visualhull80k_mvcal_v7_cal4_childcap/point_cloud/iteration_15000/point_cloud.ply}"
export WCURLY_CLEAN_OUTPUT="${WCURLY_CLEAN_OUTPUT:-${result_root}/clean_hair_stage1_visualhull80k_mvcal_v8_coverage_refine4k}"
export WCURLY_CLEAN_ITERATIONS="${WCURLY_CLEAN_ITERATIONS:-4000}"
export WCURLY_CLEAN_DENSIFY_FROM=0
export WCURLY_CLEAN_DENSIFY_UNTIL=0
export WCURLY_CLEAN_POSITION_LR_INIT="${WCURLY_CLEAN_POSITION_LR_INIT:-0.0000016}"
